...
describe("TabelaPaginationComponent", () => {
  let component: TabelaPaginationComponent;
  let fixture: ComponentFixture<TabelaPaginationComponent>;
  let de: DebugElement;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TabelaPaginationComponent);
...
function loadInputs(component: TabelaPaginationComponent) {
